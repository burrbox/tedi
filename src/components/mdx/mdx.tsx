...
export function Mdx({ content }: { content: string }) {
	return (
		...
		<div className="prose prose-headings:text-slate-200 prose-h1:text-2xl prose-a:text-blue-600 prose-a:underline prose-img:mx-auto prose-img:my-0 prose-img:w-1/2 mx-auto overflow-y-hidden p-2 text-left leading-normal">
