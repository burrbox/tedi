		...
		<div className="relative mx-auto max-w-6xl px-4 sm:px-6">
			...
			<div className="pb-12 pt-32 md:pb-20 md:pt-40">
				...
				<div className="mx-auto max-w-sm">
					...
					<button
						className="btn-sm relative my-3 flex w-full bg-gray-200 text-sm after:flex-1"
						type="button"
						onClick={() => handleSignIn("azure-ad")}>
						<div className="flex flex-1 items-center">
							<svg className="h-6 w-6 shrink-0 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23 23">
						...
						<span className="flex-auto pl-3 text-gray-800">Continue With Microsoft</span>
					</button>
					{/* Privacy Policy */}
					<div className="flex gap-1 align-middle">
						<div className="mx-auto mb-1 block font-medium text-slate-400">
