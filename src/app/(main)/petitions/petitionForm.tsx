			...
			<div className="mx-6 grid justify-center gap-3 md:flex-col lg:grid-cols-2 lg:grid-rows-3">
				...
				<div className="flex-col lg:col-span-1 lg:col-start-2 lg:row-span-1">
					<label className="text-blue-700 dark:text-blue-300">
						...
						<input
							name="lastName"
							className="w-full rounded-md bg-blue-300 p-3 shadow-blue-700 duration-200 hover:bg-blue-100 focus:bg-white dark:bg-stone-700 dark:text-white dark:hover:bg-stone-800 dark:focus:bg-stone-800 dark:focus:text-white"
							type="text"
							required
							value={lastName}
				...
				<div className="col-span-1 col-start-2 row-span-2 row-start-2 flex-col">
					<label className="text-blue-700 dark:text-blue-300">
						...
						<textarea
							name="message"
							className="h-fit w-full resize-none rounded-md bg-blue-300 p-3 shadow-blue-700 duration-200 hover:bg-blue-100 focus:bg-white dark:bg-stone-700 dark:text-white dark:hover:bg-stone-800 dark:focus:bg-stone-800 dark:focus:text-white"
							rows={5}
							value={message}
