					...
					<div className="flex flex-col-reverse gap-8 sm:flex-row">
						...
						<div className="w-4/5 px-10">
							...
							<div className="flex">
								<Link
									className="rounded-lg bg-green-500 px-5 py-3 text-center duration-300 hover:scale-110 hover:bg-green-400 dark:bg-green-600 dark:hover:bg-green-700"
									href={`https://www.canva.com/design/DAGPpNZtVdc/D6i7ps-BuymyeECKzqi7xw/edit?utm_content=DAGPpNZtVdc&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton`}
									target="_blank"
								>
									Download
								</Link>
